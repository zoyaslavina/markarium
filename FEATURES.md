...
| Responsive touch workspace | Standalone | iPad/phone drawer for files and outline, right-side iPad Notes action, compact notes overlay, safe-area and visual-viewport keyboard sizing, delayed touch selection tools, multi-file picking and large touch targets. |
